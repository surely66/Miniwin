...
static svg_status_t
_svg_trace_set_viewport (void 			*closure,
...
static svg_status_t
_svg_trace_apply_view_box (void 		*closure,
			   ...
			   const svg_length_t 	*height)
{
    ...
    return _svg_engine_apply_view_box (trace->targets->target_engine, trace->targets->target_closure,
				   ...
				   const svg_length_t 	*left)
{
    ...
    return _svg_engine_viewport_clipping_path (trace->targets->target_engine, trace->targets->target_closure,
...
_svg_trace_end_transform (void *closure)
{
    ...
    return _svg_engine_end_transform (trace->targets->target_engine, trace->targets->target_closure);
}
...
_svg_trace_set_fill_opacity (void *closure, double fill_opacity)
{
    ...
    return _svg_engine_set_fill_opacity (trace->targets->target_engine, trace->targets->target_closure,
    	fill_opacity);
}
...
_svg_trace_set_fill_paint (void *closure, const svg_paint_t *paint)
{
    ...
    return _svg_engine_set_fill_paint (trace->targets->target_engine, trace->targets->target_closure,
    	paint);
}
...
_svg_trace_set_font_family (void *closure, const char *family)
{
    ...
    return _svg_engine_set_font_family (trace->targets->target_engine, trace->targets->target_closure,
    	family);
}
...
_svg_trace_set_font_style (void *closure, svg_font_style_t font_style)
{
    ...
    return _svg_engine_set_font_style (trace->targets->target_engine, trace->targets->target_closure,
    	font_style);
}
...
_svg_trace_set_font_weight (void *closure, unsigned int font_weight)
{
    ...
    return _svg_engine_set_font_weight (trace->targets->target_engine, trace->targets->target_closure,
    	font_weight);
}
...
_svg_trace_set_marker_end (void *closure, const svg_marker_t *marker)
{
    ...
    return _svg_engine_set_marker_end (trace->targets->target_engine, trace->targets->target_closure,
    	marker);
}
...
_svg_trace_set_marker_mid (void *closure, const svg_marker_t *marker)
{
    ...
    return _svg_engine_set_marker_mid (trace->targets->target_engine, trace->targets->target_closure,
    	marker);
}
...
_svg_trace_set_marker_start (void *closure, const svg_marker_t *marker)
{
    ...
    return _svg_engine_set_marker_start (trace->targets->target_engine, trace->targets->target_closure,
    	marker);
}
...
_svg_trace_set_stroke_dash_array (void *closure, const double *dash_array, int num_dashes)
{
    ...
    return _svg_engine_set_stroke_dash_array (trace->targets->target_engine, trace->targets->target_closure,
    	dash_array, num_dashes);
}
...
_svg_trace_set_stroke_dash_offset (void *closure, const svg_length_t *offset)
{
    ...
    return _svg_engine_set_stroke_dash_offset (trace->targets->target_engine, trace->targets->target_closure,
    	offset);
}
...
_svg_trace_set_stroke_line_cap (void *closure, svg_stroke_line_cap_t line_cap)
{
    ...
    return _svg_engine_set_stroke_line_cap (trace->targets->target_engine, trace->targets->target_closure,
    	line_cap);
}
...
_svg_trace_set_stroke_line_join (void *closure, svg_stroke_line_join_t line_join)
{
    ...
    return _svg_engine_set_stroke_line_join (trace->targets->target_engine, trace->targets->target_closure,
    	line_join);
}
...
_svg_trace_set_stroke_miter_limit (void *closure, double limit)
{
    ...
    return _svg_engine_set_stroke_miter_limit (trace->targets->target_engine, trace->targets->target_closure,
    	limit);
}
...
_svg_trace_set_stroke_opacity (void *closure, double stroke_opacity)
{
    ...
    return _svg_engine_set_stroke_opacity (trace->targets->target_engine, trace->targets->target_closure,
    	stroke_opacity);
}
...
_svg_trace_set_stroke_paint (void *closure, const svg_paint_t *paint)
{
    ...
    return _svg_engine_set_stroke_paint (trace->targets->target_engine, trace->targets->target_closure,
    	paint);
}
...
_svg_trace_set_stroke_width (void *closure, const svg_length_t *width)
{
    ...
    return _svg_engine_set_stroke_width (trace->targets->target_engine, trace->targets->target_closure,
    	width);
}
...
_svg_trace_set_text_anchor (void *closure, svg_text_anchor_t text_anchor)
{
    ...
    return _svg_engine_set_text_anchor (trace->targets->target_engine, trace->targets->target_closure,
    	text_anchor);
}
...
_svg_trace_set_visibility (void *closure, int visible)
{
    ...
    return _svg_engine_set_visibility (trace->targets->target_engine, trace->targets->target_closure,
    	visible);
}
...
static svg_status_t
_svg_trace_text_advance_x (void 	*closure,
			   const char 	*utf8,
			   double 	*advance)
{
    svg_trace_t *trace = (svg_trace_t*)closure;
    ...
    status = _svg_engine_text_advance_x (trace->targets->target_engine, trace->targets->target_closure,
    	utf8, advance);
...
_svg_trace_set_text_position_x (void *closure, const svg_length_t *x)
{
    ...
    return _svg_engine_set_text_position_x (trace->targets->target_engine, trace->targets->target_closure,
    	x);
}
...
_svg_trace_set_text_position_y (void *closure, const svg_length_t *y)
{
    ...
    return _svg_engine_set_text_position_y (trace->targets->target_engine, trace->targets->target_closure,
    	y);
}
...
_svg_trace_adjust_text_position (void *closure, const svg_length_t *dx, const svg_length_t *dy)
{
    ...
    return _svg_engine_adjust_text_position (trace->targets->target_engine, trace->targets->target_closure,
    	dx, dy);
}
...
_svg_trace_set_text_chunk_width (void *closure, double width)
{
    ...
    return _svg_engine_set_text_chunk_width (trace->targets->target_engine, trace->targets->target_closure,
    	width);
}

static svg_status_t
_svg_trace_render_line (void 			*closure,
...
_svg_trace_render_path (void *closure, const svg_path_t *ext_path)
{
	...
	while (path_element != NULL) {
		...
		case SVG_PATH_OP_MOVE_TO:
		    printf ("move_to {%f, %f}\n", 
		    	path_element->p.move_to.x,
			path_element->p.move_to.y);
		    break;
		case SVG_PATH_OP_LINE_TO:
		    printf ("line_to {%f, %f}\n", 
		    	path_element->p.line_to.x,
			path_element->p.line_to.y);
		    break;
		case SVG_PATH_OP_CURVE_TO:
		    printf ("curve_to {{%f, %f}, {%f, %f}, {%f, %f}}\n", 
		    	path_element->p.curve_to.x1,
			path_element->p.curve_to.y1,
		    	path_element->p.curve_to.x2,
			path_element->p.curve_to.y2,
		    	path_element->p.curve_to.x3,
			path_element->p.curve_to.y3);
		    break;
		case SVG_PATH_OP_QUAD_CURVE_TO:
		    printf ("curve_to {{%f, %f}, {%f, %f}}\n", 
		    	path_element->p.quad_curve_to.x1,
			path_element->p.quad_curve_to.y1,
		    	path_element->p.quad_curve_to.x2,
			path_element->p.quad_curve_to.y2);
		    break;
		case SVG_PATH_OP_ARC_TO:
		    printf ("arc_to {{%f, %f}, %f, %s, %s, {%f, %f}}\n", 
		    	path_element->p.arc_to.rx,
			path_element->p.arc_to.ry,
			...
			(path_element->p.arc_to.sweep_flag ? "true" : "false"),
		    	path_element->p.arc_to.x,
			path_element->p.arc_to.y);
		    break;
...
static svg_status_t
_svg_trace_render_circle (void			*closure,
...
static svg_status_t
_svg_trace_render_ellipse (void 		*closure,
			   const svg_length_t 	*cx,
			   const svg_length_t 	*cy,
			   ...
			   const svg_length_t	*ry)
{
    ...
    return _svg_engine_render_ellipse (trace->targets->target_engine, trace->targets->target_closure,
    	cx, cy, rx, ry);
}

static svg_status_t
_svg_trace_render_rect (void 			*closure,
			const svg_length_t	*x,
			const svg_length_t 	*y,
			const svg_length_t 	*width,
			const svg_length_t 	*height,
...
static svg_status_t
_svg_trace_render_image (void			*closure,
			const char 		*uri,
			int			index,
...
static svg_status_t 
_svg_trace_measure_position (void	    	*closure,
			     ...
			     double	    	*oy)
{
    ...
    status = _svg_engine_measure_position (trace->targets->target_engine, trace->targets->target_closure,
    	ix, iy, ox, oy);
...
static svg_status_t 
_svg_trace_measure_font_size (void	    		*closure,
			      ...
			      double			*out_size)
{
    ...
    status = _svg_engine_measure_font_size (trace->targets->target_engine, trace->targets->target_closure,
    	font_family, parent_font_size, in_size, out_size);
			       ...
			       void 			*closure)
{
    ...
    if (trace->targets == NULL || 
    	!_svg_uri_equals (trace->targets->document_uri, document_uri)) 
    {
	_svg_trace_print_indent (trace->level);
	printf ("in_document(");
