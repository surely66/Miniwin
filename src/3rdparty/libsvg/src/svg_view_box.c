			 ...
			 svg_transform_t	*transform)
{
	...
	case SVG_PRESERVE_ASPECT_RATIO_XMINYMIN:
	    _svg_transform_add_translate (transform, vport_x_min - vbox_x_min, vport_y_min - vbox_y_min);
	    break;
	case SVG_PRESERVE_ASPECT_RATIO_XMIDYMIN:
	    _svg_transform_add_translate (transform, vport_x_mid - vbox_x_mid, vport_y_min - vbox_y_min);
	    break;
	case SVG_PRESERVE_ASPECT_RATIO_XMAXYMIN:
	    _svg_transform_add_translate (transform, vport_x_max - vbox_x_max, vport_y_min - vbox_y_min);
	    break;
	case SVG_PRESERVE_ASPECT_RATIO_XMINYMID:
	    _svg_transform_add_translate (transform, vport_x_min - vbox_x_min, vport_y_mid - vbox_y_mid);
	    break;
	case SVG_PRESERVE_ASPECT_RATIO_XMIDYMID:
	    _svg_transform_add_translate (transform, vport_x_mid - vbox_x_mid, vport_y_mid - vbox_y_mid);
	    break;
	case SVG_PRESERVE_ASPECT_RATIO_XMAXYMID:
	    _svg_transform_add_translate (transform, vport_x_max - vbox_x_max, vport_y_mid - vbox_y_mid);
	    break;
	case SVG_PRESERVE_ASPECT_RATIO_XMINYMAX:
	    _svg_transform_add_translate (transform, vport_x_min - vbox_x_min, vport_y_max - vbox_y_max);
	    break;
	case SVG_PRESERVE_ASPECT_RATIO_XMIDYMAX:
	    _svg_transform_add_translate (transform, vport_x_mid - vbox_x_mid, vport_y_max - vbox_y_max);
	    break;
	case SVG_PRESERVE_ASPECT_RATIO_XMAXYMAX:
	    _svg_transform_add_translate (transform, vport_x_max - vbox_x_max, vport_y_max - vbox_y_max);
	    break;
...
void
svg_complete_image_viewbox (svg_view_box_t	*view_box,
			    double		image_width,
			    double		image_height)
{
