...
_svg_svg_group_init (svg_svg_group_t *svg_group)
{
    ...
    _svg_length_init_unit (&svg_group->width, 100, SVG_LENGTH_UNIT_PCT, SVG_LENGTH_ORIENTATION_HORIZONTAL);
    _svg_length_init_unit (&svg_group->height, 100, SVG_LENGTH_UNIT_PCT, SVG_LENGTH_ORIENTATION_VERTICAL);
				 ...
				 const svg_nsatts_t	*attributes)
{
	...
	return _svg_element_return_property_error (svg_group_element, "width", SVG_STATUS_INVALID_VALUE);
	...
	return _svg_element_return_property_error (svg_group_element, "height", SVG_STATUS_INVALID_VALUE);
	...
	_svg_attribute_get_string (attributes, "preserveAspectRatio", &aspect_ratio_str, "xMidYMid meet");
	status = _svg_view_box_parse_aspect_ratio (aspect_ratio_str, &svg_group->view_box);
	if (status)
	    return _svg_element_return_property_error (svg_group_element, "preserveAspectRatio", status);
    }
