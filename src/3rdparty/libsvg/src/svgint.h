...
typedef struct svg_parser_state {
    ...
    svg_tspan_t			*tspan;
    svg_css_stylesheet_t        *stylesheet;//added by zhhou
...
svg_status_t
_svg_resolve_element_href (svg_t 		*svg,
			   svg_uri_t		*document_uri,
			   svg_uri_t		*base_uri,
			   const char 		*href,
			   svg_element_t	**element);
...
svg_status_t
_svg_resolve_element_url (svg_t 	*svg,
			  svg_uri_t	*document_uri,
			  svg_uri_t	*base_uri,
			  const char 	*url,
			  svg_element_t **element);
...
svg_status_t
_svg_register_image_uri (svg_t		*svg,
			 svg_uri_t	*uri,
			 int		*index);
...
void
_svg_set_error_element_name (svg_t *svg, const svg_nsname_t *element_name);
...
svgint_status_t
_svg_attribute_get_double (const svg_nsatts_t	*attributes,
			   const char		*name,
			   double		*value,
			   double	 	default_value);

svgint_status_t
_svg_attribute_get_string (const svg_nsatts_t	*attributes,
			   const char		*name,
			   const char		**value,
			   const char		*default_value);

svgint_status_t
_svg_attribute_get_string_ns (const svg_nsatts_t	*attributes,
			      int			ns_index,
			      const char		*name,
			      const char		**value,
			      const char		*default_value);
...
svgint_status_t
_svg_attribute_get_length (const svg_nsatts_t	*attributes,
			   const char		*name,
			   svg_length_t		*value,
			   const char		*default_value);
...
svg_status_t
_svg_clip_path_init_copy (svg_clip_path_int_t 	*clip_path,
...
svg_status_t
_svg_clip_path_apply_attributes (svg_element_t 		*clip_path_element,
				 const svg_nsatts_t	*attributes);

int
_svg_clip_path_peek_render (svg_element_t *element, svg_render_engine_t *engine);

svg_status_t
_svg_clip_path_render (svg_element_t		*element,
		       svg_render_engine_t	*engine,
		       void			*closure);
...
svg_status_t
_svg_container_init_copy (svg_container_t *container,
			  svg_container_t *other);
...
svg_status_t
_svg_container_render (svg_container_t		*container,
		       svg_render_engine_t	*engine,
		       void			*closure);
...
svg_status_t 
_svg_parse_external_css_stylesheet (svg_css_stylesheet_t	*stylesheet, 
				    svg_uri_t 			*uri);

svg_status_t 
_svg_parse_inline_css (svg_css_declaration_t **declarations, 
		       int *num_declarations, 
		       const char *data, 
		       size_t count);

svg_status_t
_svg_get_css_stylesheet_declarations (svg_css_declaration_t **declarations, 
				      int *num_declarations, 
				      svg_dom_node_t *node, 
				      svg_css_stylesheet_t *stylesheet);
	
void
_svg_destroy_css_declarations (svg_css_declaration_t *declarations, 
			       int num_declarations);
...
svg_status_t
_svg_dom_create_nsname (svg_nsname_t 	**nsname,
			int		ns_index,
		        const char 	*local_name);

svg_status_t
_svg_dom_init_nsname (svg_nsname_t 	*nsname,
		      int		ns_index,
		      const char 	*local_name);

void
_svg_dom_deinit_nsname (svg_nsname_t *nsname);

void
_svg_dom_destroy_nsname (svg_nsname_t *nsname);

svg_status_t
_svg_dom_create_nsatts (svg_nsatts_t 	**nsatts,
			int		num_nsatts);

svg_status_t
_svg_dom_init_nsatt (svg_nsatt_t 	*nsatt, 
		     int	 	ns_index,
		     const char 	*local_name, 
		     const char		*value);
		     
void
_svg_dom_deinit_nsatt (svg_nsatt_t *nsatt);

void
_svg_dom_destroy_nsatts (svg_nsatts_t *nsatts);

int
_svg_compare_nsname (svg_nsname_t *left, svg_nsname_t *right);

int
_svg_compare_nsname_2 (svg_nsname_t *left, int ns_index, const char *local_name);

int
_svg_compare_nsname_svg (svg_nsname_t *left, const char *svg_local_name);

svg_status_t
_svg_dom_register_uri (svg_dom_t *dom, const char *uri, int *index);

svg_status_t
_svg_create_dom_node (svg_dom_node_t **node, svg_dom_node_type_t type);

svg_status_t
_svg_destroy_dom_node (svg_dom_node_t *node);

svg_status_t
_svg_dom_start_element (svg_dom_t 	*dom, 
			svg_nsname_t 	*nsname, 
			svg_nsatts_t	*nsatts,
			svg_dom_node_t 	**node); 

svg_status_t
_svg_dom_end_element (svg_dom_t 	*dom, 
		      svg_nsname_t 	*nsname);

svg_status_t
_svg_dom_characters (svg_dom_t 		*dom, 
		     const char 	*ch, 
		     size_t 		len,
		     svg_dom_node_t 	**node);

svg_status_t
_svg_dom_deep_clone_node (svg_dom_node_t **clone, 
			  svg_dom_node_t *parent, 
			  svg_dom_node_t *from_node);

svg_status_t
_svg_dom_node_set_nsname (svg_dom_node_t 	*node, 
			  int 			ns_index, 
			  const char 		*local_name);

svg_status_t
_svg_dom_node_set_nsattr (svg_dom_node_t 	*node, 
			  int 			ns_index, 
			  const char 		*local_name, 
			  const char 		*value);
...
void
_svg_dom_node_set_base_uri (svg_dom_node_t 	*node, 
			    svg_uri_t 		*base_uri, 
			    int 		own_base_uri);
...
svg_status_t
_svg_normalize_character_data (svg_dom_node_t 	*node,
			       char 		**ch_data,
			       size_t		*ch_data_offset,
			       size_t		*ch_data_len);
...
svg_status_t
_svg_create_virtual_element (svg_element_t 	**element, 
			     svg_element_type_t type,
			     svg_dom_node_t	*style_node,
			     svg_element_t	*parent,
			     svg_t		*svg);
...
svg_status_t
_svg_element_return_property_error (svg_element_t	*element,
...
svg_status_t
_svg_create_element_ref (svg_element_ref_t **element_ref, svg_element_t	*element);

void
_svg_destroy_element_ref (svg_element_ref_t *element_ref);

svg_status_t
_svg_clone_element_ref (svg_element_ref_t **element_ref, svg_element_ref_t *other);
...
svg_status_t
_svg_gradient_stop_init_copy (svg_gradient_stop_t *stop,
			      svg_gradient_stop_t *other);

svg_status_t
_svg_gradient_stop_deinit (svg_gradient_stop_t *stop);

svg_status_t
_svg_gradient_stop_apply_attributes (svg_element_t 	*stop,
				     const svg_nsatts_t	*attributes);
svg_status_t
_svg_gradient_stop_apply_style (svg_gradient_stop_t	*stop,
				svg_style_t		*style);
...
svg_status_t
_svg_gradient_init_copy (svg_gradient_int_t *gradient,
			 svg_gradient_int_t *other);

svg_status_t
_svg_gradient_deinit (svg_gradient_int_t *gradient);

svg_status_t
_svg_gradient_set_type (svg_gradient_int_t *gradient,
			svg_gradient_type_t type);

svg_status_t
_svg_gradient_add_stop (svg_gradient_int_t 	*gradient,
			svg_gradient_stop_t	*stop);

svg_status_t
_svg_gradient_apply_attributes (svg_element_t		*gradient_element,
				const svg_nsatts_t	*attributes);
...
svg_status_t
_svg_group_apply_attributes (svg_element_t		*group_element,
			     const svg_nsatts_t		*attributes);
...
svg_status_t
_svg_group_render (svg_element_t	*element,
		   svg_render_engine_t	*engine,
		   void			*closure);
...
svg_status_t
_svg_image_apply_attributes (svg_element_t	*image_element,
			     const svg_nsatts_t	*attributes);
...
svg_status_t
_svg_image_render (svg_element_t	*element,
		   svg_render_engine_t	*engine,
		   void			*closure);
...
svg_status_t
_svg_length_init_from_array_str (svg_length_t 	*length, 
				 const char 	*str, 
				 const char 	**after_unit);
...
svg_status_t
_svg_marker_init_copy (svg_marker_int_t	*marker,
...
svg_status_t
_svg_marker_apply_attributes (svg_element_t		*marker_element,
			      const svg_nsatts_t	*attributes);
...
svg_status_t
_svg_marker_render (svg_element_t	*element,
		    svg_render_engine_t	*engine,
		    void		*closure);
...
svg_status_t
_svg_mask_init_copy (svg_mask_int_t 	*mask,
		     svg_element_t 	*mask_element,
		     svg_mask_int_t	*other);

svg_status_t
_svg_mask_deinit (svg_mask_int_t *mask);

svg_status_t
_svg_mask_apply_attributes (svg_element_t 	*mask_element,
			    const svg_nsatts_t	*attributes);
...
svg_status_t
_svg_mask_render (svg_element_t		*element,
		  svg_render_engine_t	*engine,
		  void			*closure);
...
svg_status_t
_svg_paint_init (svg_paint_t 	*paint, 
		 svg_t 		*svg,
		 svg_uri_t	*document_uri,
		 svg_uri_t	*base_uri,
		 const char 	*str);
...
void
_svg_parser_set_error (svg_parser_t 	*parser, 
		       long 		line_number,
		       svg_status_t	error_status);
...
_svg_parser_set_node_error (svg_parser_t 	*parser, 
		       	    long 		line_number,
			    svg_nsname_t	*node_nsname,
			    svg_status_t	error_status);

void
_svg_parser_set_attr_error (svg_parser_t 	*parser, 
			    const char		*attr_local_name,
			    svg_status_t	error_status);

svg_status_t
_svg_parser_return_error (svg_parser_t	*parser,
			  svg_status_t	error_status);
...
svg_status_t
_svg_parser_return_attr_error (svg_parser_t	*parser,
			       const char	*attr_local_name,
			       svg_status_t	error_status);
...
svg_status_t
_svg_parser_create_deferred_element (svg_parser_t 	*parser, 
				     svg_element_t 	*element);
					     
svg_status_t
_svg_parser_copy_xml_name (svg_dom_t 		*dom, 
			   svg_nsname_t 	**nsname, 
			   const xmlChar 	*xml_name);

svg_status_t
_svg_parser_copy_xml_attributes (svg_dom_t 	*dom, 
				 svg_nsatts_t 	**nsatts, 
				 int		element_ns_index, 
...
void
_svg_parser_sax_proc_instr (void		*closure,
			    const xmlChar	*target,
			    const xmlChar	*data);

void
_svg_parser_pseudo_proc_instr_start_element (void		*closure,
			       		     const xmlChar	*xml_name,
					     const xmlChar	**xml_atts);
...
svg_status_t
_svg_path_init_copy (svg_path_int_t *path,
		     svg_path_int_t *other);
...
svg_status_t
_svg_path_render (svg_element_t		*element,
		  svg_render_engine_t	*engine,
		  void			*closure);

svg_status_t
_svg_path_apply_attributes (svg_element_t	*path_element,
			    const svg_nsatts_t	*attributes);
...
svg_status_t
_svg_path_curve_to (svg_path_int_t *path,
		    double x1, double y1,
		    double x2, double y2,
		    double x3, double y3);

svg_status_t
_svg_path_rel_curve_to (svg_path_int_t *path,
			double dx1, double dy1,
			double dx2, double dy2,
			double dx3, double dy3);

svg_status_t
_svg_path_smooth_curve_to (svg_path_int_t *path,
			   double x2, double y2,
			   double x3, double y3);
...
svg_status_t
_svg_path_quadratic_curve_to (svg_path_int_t *path,
			      double x1, double y1,
			      double x2, double y2);

svg_status_t
_svg_path_rel_quadratic_curve_to (svg_path_int_t *path,
				  double dx1, double dy1,
				  double dx2, double dy2);

svg_status_t
_svg_path_smooth_quadratic_curve_to (svg_path_int_t *path,
				     double x2, double y2);

svg_status_t
_svg_path_rel_smooth_quadratic_curve_to (svg_path_int_t *path,
					 double dx2, double dy2);
...
svg_status_t
_svg_path_arc_to (svg_path_int_t	*path,
		  double		rx,
		  double		ry,
...
svg_status_t
_svg_path_rel_arc_to (svg_path_int_t	*path,
		      double		rx,
		      double		ry,
		      double		x_axis_rotation,
		      int		large_arc_flag,
...
svg_status_t
_svg_pattern_init_copy (svg_pattern_int_t 	*pattern,
...
svg_status_t
_svg_pattern_apply_attributes (svg_element_t		*pattern_element,
			       const svg_nsatts_t 	*attributes);
...
svg_status_t
_svg_pattern_render (svg_element_t		*element,
		     svg_render_engine_t	*engine,
		     void			*closure);
...
svg_status_t
_svg_engine_begin_group (svg_render_engine_t 	*engine,
			 void 			*closure,
			 double 		opacity,
			 const char 		*id,
			 const char 		*klass);
...
svg_status_t
_svg_engine_begin_element (svg_render_engine_t	*engine,
			   void 		*closure,
			   const char 		*id,
			   const char 		*klass);

svg_status_t
_svg_engine_end_element (svg_render_engine_t	*engine,
			 void 			*closure);

svg_status_t
_svg_engine_end_group (svg_render_engine_t	*engine,
		       void 			*closure,
		       double 			opacity);

svg_status_t
_svg_engine_set_viewport (svg_render_engine_t 	*engine,
			  void 			*closure,
...
svg_status_t
_svg_engine_apply_view_box (svg_render_engine_t		*engine,
			    void 			*closure,
...
svg_status_t
_svg_engine_viewport_clipping_path (svg_render_engine_t	*engine,
				    void 		*closure,
...
svg_status_t
_svg_engine_transform (svg_render_engine_t 	*engine,
		       void 			*closure, 
...
svg_status_t
_svg_engine_set_clip_path (svg_render_engine_t 		*engine, 
			   void 			*closure, 
			   const svg_clip_path_t	*clip_path);

svg_status_t
_svg_engine_set_clip_rule (svg_render_engine_t	*engine,
			   void 		*closure,
			   svg_clip_rule_t	clip_rule);

svg_status_t
_svg_engine_set_color (svg_render_engine_t 	*engine,
		       void 			*closure, 
		       const svg_color_t 	*color);

svg_status_t
_svg_engine_set_fill_opacity (svg_render_engine_t 	*engine,
			      void 			*closure,
			      double 			fill_opacity);

svg_status_t
_svg_engine_set_fill_paint (svg_render_engine_t	*engine,
			    void 		*closure,
			    const svg_paint_t 	*paint);

svg_status_t
_svg_engine_set_fill_rule (svg_render_engine_t 	*engine,
			   void 		*closure,
			   svg_fill_rule_t 	fill_rule);

svg_status_t
_svg_engine_set_font_family (svg_render_engine_t 	*engine,
			     void 			*closure,
			     const char 		*family);

svg_status_t
_svg_engine_set_font_size (svg_render_engine_t 	*engine,
			   void 		*closure,
			   double 		size);
...
svg_status_t
_svg_engine_set_font_weight (svg_render_engine_t 	*engine,
			     void 			*closure,
			     unsigned int 		font_weight);
...
svg_status_t
_svg_engine_set_mask (svg_render_engine_t 	*engine,
		      void 			*closure,
		      const svg_mask_t 		*mask);

svg_status_t
_svg_engine_set_opacity (svg_render_engine_t 	*engine,
			 void 			*closure,
			 double 		opacity);

svg_status_t
_svg_engine_set_stroke_dash_array (svg_render_engine_t 	*engine,
				   void 		*closure,
				   const double		*dash_array,
				   int 			num_dashes);

svg_status_t
_svg_engine_set_stroke_dash_offset (svg_render_engine_t	*engine,
				    void 		*closure,
				    const svg_length_t 	*offset);

svg_status_t
_svg_engine_set_stroke_line_cap (svg_render_engine_t 	*engine,
				 void 			*closure,
				 svg_stroke_line_cap_t 	line_cap);

svg_status_t
_svg_engine_set_stroke_line_join (svg_render_engine_t 		*engine,
				  void 				*closure,
				  svg_stroke_line_join_t	line_join);

svg_status_t
_svg_engine_set_stroke_miter_limit (svg_render_engine_t	*engine,
				    void 		*closure,
				    double 		limit);

svg_status_t
_svg_engine_set_stroke_opacity (svg_render_engine_t 	*engine,
				void 			*closure,
				double 			stroke_opacity);

svg_status_t
_svg_engine_set_stroke_paint (svg_render_engine_t 	*engine,
			      void 			*closure,
			      const svg_paint_t 	*paint);

svg_status_t
_svg_engine_set_stroke_width (svg_render_engine_t 	*engine,
			      void 			*closure,
			      const svg_length_t	*width);

svg_status_t
_svg_engine_set_text_anchor (svg_render_engine_t	*engine,
			     void 			*closure,
			     svg_text_anchor_t 		text_anchor);

svg_status_t
_svg_engine_set_visibility (svg_render_engine_t	*engine,
			    void 		*closure,
			    int 		visible);
...
svg_status_t
_svg_engine_text_advance_x (svg_render_engine_t	*engine,
			    void 		*closure,
			    const char 		*utf8,
			    double 		*advance);

svg_status_t
_svg_engine_set_text_position_x (svg_render_engine_t 	*engine,
				 void 			*closure,
				 const svg_length_t	*x);

svg_status_t
_svg_engine_set_text_position_y (svg_render_engine_t 	*engine,
				void 			*closure,
				const svg_length_t	*y);

svg_status_t
_svg_engine_adjust_text_position (svg_render_engine_t 	*engine,
				  void 			*closure,
				  const svg_length_t	*dx,
				  const svg_length_t	*dy);

svg_status_t
_svg_engine_set_text_chunk_width (svg_render_engine_t *engine,
				  void *closure,
				  double width);

svg_status_t
_svg_engine_render_line (svg_render_engine_t 	*engine,
			 void 			*closure,
			 const svg_length_t	*x1,
			 const svg_length_t	*y1,
			 const svg_length_t	*x2,
			 const svg_length_t	*y2);

svg_status_t
_svg_engine_render_path (svg_render_engine_t 	*engine,
			 void 			*closure,
			 const svg_path_t	*ext_path);

svg_status_t
_svg_engine_render_circle (svg_render_engine_t 	*engine,
			   void 		*closure,
...
svg_status_t
_svg_engine_render_ellipse (svg_render_engine_t	*engine,
			    void 		*closure,
			    const svg_length_t 	*cx,
			    const svg_length_t 	*cy,
...
svg_status_t
_svg_engine_render_rect (svg_render_engine_t 	*engine,
			 void 			*closure,
			 const svg_length_t 	*x,
			 const svg_length_t 	*y,
			 const svg_length_t 	*width,
...
svg_status_t
_svg_engine_render_text (svg_render_engine_t 	*engine,
			 void 			*closure,
			 const char   		*utf8);

svg_status_t
_svg_engine_render_image (svg_render_engine_t	*engine,
			  void			*closure,
			  const char 		*uri,
			  int			index,
...
svg_status_t
_svg_engine_measure_position (svg_render_engine_t	*engine,
			      void			*closure,
...
svg_status_t 
_svg_engine_measure_font_size (svg_render_engine_t	*engine,
			       void			*closure,
...
svg_status_t
_svg_resource_read_stream (svg_uri_t 				*uri, 
			   void 				*cb_closure, 
			   svg_resource_read_stream_cb_t	*read_cb);

svg_status_t
_svg_resource_read_stream_to_buffer (svg_uri_t	*uri, 
				     char	**buffer, 
				     size_t 	*buffer_size,
				     size_t	max_buffer_size);

svg_status_t
_svg_resource_get_access_filename (svg_uri_t 	*uri, 
				   char 	**filename, 
				   int 		*is_temp_copy);
...
svg_status_t
_svg_circle_apply_attributes (svg_element_t		*circle_element,
			      const svg_nsatts_t	*attributes);

svg_status_t
_svg_ellipse_apply_attributes (svg_element_t		*ellipse_element,
			      const svg_nsatts_t	*attributes);

svg_status_t
_svg_line_apply_attributes (svg_element_t		*line_element,
			      const svg_nsatts_t	*attributes);

svg_status_t
_svg_rect_apply_attributes (svg_element_t		*rect_element,
			      const svg_nsatts_t	*attributes);
...
svg_status_t
_svg_circle_render (svg_element_t	*element,
		    svg_render_engine_t	*engine,
		    void		*closure);
...
svg_status_t
_svg_ellipse_render (svg_element_t		*element,
		     svg_render_engine_t	*engine,
		     void			*closure);
...
svg_status_t
_svg_line_render (svg_element_t		*element,
		  svg_render_engine_t	*engine,
		  void			*closure);
...
svg_status_t
_svg_rect_render (svg_element_t		*element,
		  svg_render_engine_t	*engine,
		  void			*closure);
...
svg_status_t
_svg_style_render (svg_dom_node_t	*node,
		   svg_render_engine_t	*engine,
		   void			*closure);
...
svg_status_t
_svg_style_apply_properties (svg_dom_node_t	*node, 
			     svg_t		*svg);
...
svg_status_t
_svg_svg_group_init_copy (svg_svg_group_t *svg_group,
			  svg_svg_group_t *other);

svg_status_t
_svg_svg_group_deinit (svg_svg_group_t *svg_group);

svg_status_t
_svg_svg_group_apply_attributes (svg_element_t		*svg_group_element,
				 const svg_nsatts_t	*attributes);
...
svg_status_t
_svg_svg_group_render (svg_element_t		*element,
		       svg_render_engine_t	*engine,
		       void			*closure);

svg_status_t
_svg_svg_group_get_size (svg_svg_group_t 	*svg_group, 
			 svg_length_t 		*width, 
			 svg_length_t 		*height);
...
svg_status_t
_svg_symbol_init_copy (svg_symbol_t *symbol,
		       svg_symbol_t *other);
...
svg_status_t
_svg_symbol_apply_attributes (svg_element_t		*symbol_element,
			      const svg_nsatts_t	*attributes);
...
svg_status_t
_svg_tspan_apply_attributes (svg_element_t	*tspan_element,
			     const svg_nsatts_t	*attributes);
...
svg_status_t
_svg_text_render (svg_element_t		*element,
		  svg_render_engine_t	*engine,
		  void			*closure);

svg_status_t
_svg_text_apply_attributes (svg_element_t	*text_element,
			    const svg_nsatts_t	*attributes);
...
svg_status_t
_svg_trace_push_target_engine (svg_trace_t 		*trace, 
			       const svg_uri_t		*document_uri, 
			       svg_render_engine_t 	*engine, 
			       void 			*closure);
...
void
_svg_trace_set_position_info (svg_trace_t	*trace,
			      const char	*node_name,
			      long		line_number);

void
_svg_trace_get_engine (svg_trace_t 		*trace, 
		       svg_render_engine_t 	**engine, 
		       void 			**closure);
...
svg_status_t
_svg_transform_apply_attributes (svg_element_t		*element,
				 svg_transform_t	*transform,
				 const svg_nsatts_t	*attributes);
...
svg_status_t
_svg_uri_clone (svg_uri_t **uri, svg_uri_t *other);
...
svg_status_t
_svg_create_uri_ref (const char 	*uri_ref_str, 
		     svg_uri_t 		*base_uri,
		     svg_uri_t		*document_uri,
		     svg_uri_ref_t 	**uri_ref);

svg_status_t
_svg_create_uri_ref_url (const char 	*attribute, 
			 svg_uri_t 	*base_uri, 
			 svg_uri_t	*document_uri,
			 svg_uri_ref_t 	**uri_ref);
...
svg_status_t
_svg_use_init_copy (svg_use_t *use,
		    svg_use_t *other);
...
svg_status_t
_svg_use_apply_attributes (svg_element_t	*use_element,
			   const svg_nsatts_t	*attributes);
...
svg_status_t
_svg_use_render (svg_element_t		*element,
		 svg_render_engine_t	*engine,
		 void			*closure);
...
svg_status_t
_svg_view_box_parse_aspect_ratio (const char 		*aspect_ratio_str,
				  svg_view_box_t 	*view_box);
