...
#ifndef __CAIROMM_NGL_SURFACE_H
#define __CAIROMM_NGL_SURFACE_H
...
public:
   ...
   */
  explicit NGLSurface(cairo_surface_t* cobject, bool has_reference = false);
  ~NGLSurface() override;
   ...
   */
  static RefPtr<NGLSurface> create(Format format, int width, int height);
