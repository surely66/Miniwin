...
ChannelEditorWindow::ChannelEditorWindow(int x,int y,int w,int h):NTVWindow(x,y,w,h){
    ...
    addTipInfo("help_icon_exit.png","Exit",50,120);
    addTipInfo("help_icon_red.png","Set Favorites",-1,200);
    addTipInfo("help_icon_green.png","Delete",-1,120);
    addTipInfo("help_icon_yellow.png","Lock",-1,120);
    addTipInfo("help_icon_blue.png","Move",-1,120);
